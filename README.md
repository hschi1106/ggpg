...
This fork adds optional CUDA execution backends for exact and batched GP-GOMEA evaluation. See [README_GPU.md](README_GPU.md) for build flags, backend semantics, and reproduction scripts.
